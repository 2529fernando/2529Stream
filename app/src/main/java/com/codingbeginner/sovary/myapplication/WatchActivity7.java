...
public class WatchActivity7 extends AppCompatActivity {
    ExoPlayer exoPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_watch7);
        ...
        if (videoUrl != null) {
            ...
            exoPlayer.prepare();
            exoPlayer.seekTo(playbackPosition); // Restaurar la posición de reproducción
            exoPlayer.play();
        }
    }
                    ...
                    public void onAdLoaded(@NonNull RewardedInterstitialAd p0) {
                        ...
                        new CountDownTimer(4000, 1000) {
                            ...
                            public void onFinish() {
                                ...
                                rewardedInterstitialAd.show(WatchActivity7.this, rewardItem -> {
