...
public class WatchActivity8 extends AppCompatActivity {
    ExoPlayer exoPlayer;
    ImageView bt_fullscreen;
    boolean isFullScreen=false;
    boolean isLock = false;
    Handler handler;
    long playbackPosition = 0; // Guardar la posición de reproducción
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.getData() != null) {
            ...
            Toast.makeText(this, "No se proporcionó URI del video", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
    ...
    private void initializePlayer() {
        ...
        // Obtener la referencia de PlayerView desde el layout
        playerView = findViewById(R.id.player);

        // Asignar el ExoPlayer a PlayerView
        playerView.setPlayer(exoPlayer);
        ...
        exoPlayer.addListener(new Player.Listener() {
            ...
            public void onPlaybackStateChanged(int playbackState) {
                // Tu código de gestión del estado de reproducción aquí
            }
        });
    }
                    ...
                    public void onAdLoaded(@NonNull RewardedInterstitialAd p0) {
                        ...
                        new CountDownTimer(4000, 1000) {
                            ...
                            public void onFinish() {
                                ...
                                rewardedInterstitialAd.show(WatchActivity8.this, rewardItem -> {
