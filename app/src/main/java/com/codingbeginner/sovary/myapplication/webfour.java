...
public class webfour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_webfour);
        ...
        Uri videoUrl = Uri.parse("https://spa-ha-p004.cdn.masmediatv.es/SVoriginOperatorEdge/smil:17_HD.smil/manifest.m3u8");
                    ...
                    public void onAdLoaded(@NonNull RewardedInterstitialAd p0)
                    {
                        ...
                        new CountDownTimer(4000,1000)
                        {
                            ...
                            public void onFinish()
                            {
                                ...
                                rewardedInterstitialAd.show(webfour.this, rewardItem ->
                                {
