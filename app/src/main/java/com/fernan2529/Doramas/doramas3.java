...
public class doramas3 extends AppCompatActivity {
    ...
    private void openWeb(String url) {
        Intent intent = new Intent(doramas3.this, WebViewActivityGeneral.class);
        intent.putExtra("url", url); // <- clave que espera tu WebViewActivityGeneral
