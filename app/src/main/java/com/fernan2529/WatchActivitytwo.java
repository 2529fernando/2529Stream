...
public class WatchActivitytwo extends AppCompatActivity
{
    ExoPlayer exoPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Uri videoUrl = Uri.parse("https://d3696l48vwq25d.cloudfront.net/v1/master/3722c60a815c199d9c0ef36c5b73da68a62b09d1/cc-0g2918mubifjw/index.m3u8");
                    ...
                    public void onAdLoaded(@NonNull RewardedInterstitialAd p0)
                    {
                        ...
                        new CountDownTimer(4000,1000)
                        {
                            ...
                            public void onFinish()
                            {
                                ...
                                rewardedInterstitialAd.show(WatchActivitytwo.this, rewardItem ->
                                {
